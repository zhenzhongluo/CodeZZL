...
{
    /*
        This is the State class that manages each state's behaviors and decisions.
        All states will be updated/used by the state machine class (StateController.cs)
    */
